...
class CreateContextExternalToolInteractionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('context_external_tool_interactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('context_external_tool_interactions');
    }
}
