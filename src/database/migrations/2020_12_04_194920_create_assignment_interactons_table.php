...
class CreateAssignmentInteractonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assignment_interactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('assignment_interactions');
    }
}
