...
class CreateAttachmentInteractionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('attachment_interactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('attachment_interactions');
    }
}
