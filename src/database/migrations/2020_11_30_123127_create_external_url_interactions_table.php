...
class CreateExternalUrlInteractionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('external_url_interactions', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('external_url_interactions');
    }
}
